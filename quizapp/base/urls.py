...
urlpatterns = [
    ...
    path(
        "teacher",
        login_required(views.DashboardTeacher.as_view(),  login_url='home'),
        name="dashboard-teacher",
    ),
    path(
        "student",
        login_required(views.DashboardStudent.as_view(),  login_url='home'),
        name="dashboard-student",
    ),
    path(
        "admin",
        login_required(views.DashboardAdmin.as_view(), login_url='home'),
        name = "dashboard-admin",
    ),
    path(
        "teacher/<str:pk>/",
        login_required(views.UpdateTeacherProfile.as_view(), login_url='home'),
        name="update-teacher",
    ),
    path(
        "student/<str:pk>/",
        login_required(views.UpdateStudentProfile.as_view(),login_url='home'),
        name="update-student",
    ),
